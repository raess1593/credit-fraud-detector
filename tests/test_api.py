...
class TestAPI(unittest.TestCase):
    ...
    def test_load_production_model(self, mock_set_uri, mock_set_exp, mock_load_model, mock_get_uri):
        ...
        mock_load_model.assert_called_once_with("models:/credit-fraud-detector/Production")
        self.assertEqual(api_module.production_model, mock_model)
        self.assertEqual(api_module.production_model_uri, "models:/credit-fraud-detector/Production")
